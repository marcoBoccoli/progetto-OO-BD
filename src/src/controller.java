...
public class controller {
	...
	public void progetto() {
		tmplog=new login(this, new getImage("src/image/logo.png").pic);
	...
	public void evokewindow(int type, String matricola) {
		switch(type) {
		case 1:
			//System.out.println("un crea inserzione con indice:"+matricola);
			
			new window(matricola, this);
			break;
		case 2:
			//System.out.println("un crea offerta con indice:"+matricola);
			
			new window_offer(matricola.split(";") , this);
			break;
		case 3:
			//System.out.println("un delete inserzione chiamato con indice:"+matricola);
			...
			break;
		case 4:
			//System.out.println("un delete offerta chiamato con indice:"+matricola);
			...
			break;
		case 5:
			//System.out.println("un update offerta chiamato con indice:"+matricola);
